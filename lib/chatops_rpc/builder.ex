defmodule ChatopsRPC.Builder do
  ...
  @doc """
  Defines your applications namespace. This name will be used as the prefix
  for your commands if no other prefix is given.
  """
  ...
  @doc """
  Defines a command. Regexes must provide named capture groups. Otherwise
  captures will be ignored.
  """
